...
var ProblemsListComponent = (function () {
    function ProblemsListComponent(problemservice) {
    ...
    ProblemsListComponent.prototype.ngOnDestroy = function () {
        this.partiesSub.unsubscribe();
    };
    ProblemsListComponent = __decorate([
        core_1.Component({
            selector: "problems-list",
            template: "./Problems.component.html"
        }), 
        __metadata('design:paramtypes', [ProblemService_1.ProblemService])
    ], ProblemsListComponent);
    return ProblemsListComponent;
}());
exports.ProblemsListComponent = ProblemsListComponent;
